package com.eomaxl.apigateway.filter;

import com.eomaxl.apigateway.util.JwtUtils;
...
import com.eomaxl.apigateway.exception.JwtTokenMissingException;
import com.eomaxl.apigateway.exception.JwtMalformedException;
...
@Slf4j
public class JwtAuthenticationFilter implements GatewayFilterChain {
    ...
    public Mono<Void> filter(ServerWebExchange exchange) {
        ...
        if (isApiSecured.test(request)) {
            ...
            } catch (IllegalArgumentException | JwtMalformedException | JwtTokenMissingException
